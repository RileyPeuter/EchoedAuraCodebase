...
public class GlobalGameController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        available.Add(new Mission("First Contracted Mission", "(Don't pick this, you'll crash my game REEEEEEEEEEEEEEEEEEEEEEEE)End the day and recieve your first Contracted mission", "Agency", MissionType.Character, 5, -258.4F, -40F));
